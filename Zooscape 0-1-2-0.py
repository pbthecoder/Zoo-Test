...
shop_animals = [] #["Halbert", "Zilla"]
shop_ages = [] #["7","3"]
shop_species = [] #["Mountain Goat", "Gila Monster"]
shop_cost = []
shop_data = []
shopagain = False
balance = 10000000
...
while RUNNING_GAME:
    if screen == "homescreen":
        ...
        print("Zooscape 0.50".center(100," "))
    ...
    if screen == "play":
        ...
        if animals == []:
            ...
            print("'animal book' shows your animal book directory,")
            print("and finally, 'exit' will exit your current game, as well as the data. ")
    ...
    if screen == "my animal book":
        ...
        if inp == "exit":
            ...
            print("----------------------------------------------------------------------------------------")
    if screen == "codes":
        print("Welcome to the codes page. Are you ready to hack the promotional content, the good free money, and the good little free items?")
        inp = input("// ")
        inp = inp.upper()
        if inp in codes:
            if inp == "HALBERT":
                ...
                date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
                time_acquired.append(date_time)
                print("You have acquired Zilla (5-year old Gila Monster)!")
                codes.remove("ZILLA")
                ...
                print("Sunday the Babirusa is here to brighten your day!")
                animals.append("Sunday")
                species.append("Sulawesian Babirusa")
                ages.append("7")
                date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
                time_acquired.append(date_time)
                print("You have acquired Sunday (7-year old Sulawesian Babirusa)!")
